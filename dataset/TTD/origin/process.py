...
drug_features = pd.read_csv("drugs_features.csv")
...
drug_features.to_csv("drug_normalized_aligned.csv")  # 保存调整后的文件

# 3. 调整 protein_normalized.csv 顺序
protein_features = pd.read_csv("proteins_features.csv")
...
protein_features.to_csv("protein_normalized_aligned.csv")  # 保存调整后的文件
